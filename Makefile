...
#    Updated: 2018/04/09 10:35:34 by lpoujade         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
obj=ft_realloc.o ft_printf/printers.o ft_printf/printers_num.o ft_printf/ft_printf.o ft_printf/utils.o ft_printf/modes.o ft_printf/utils_modes.o ft_printf/ft_putn.o ft_printf/utils_ndigits_pads.o ft_strcchr.o ft_atoi_base.o ft_strncat.o ft_put.o ft_strmapi.o ft_strinsert.o ft_strtrim.o ft_strdel.o ft_putchar.o ft_strncmp.o ft_strlen.o ft_strnew.o ft_strlcat.o ft_striter.o ft_swap.o ft_strrmstr.o ft_to.o ft_strsub.o ft_memalloc.o ft_strtnew.o ft_lstadd_funcs.o ft_strnstr.o ft_striteri.o logf.o logf_intern.o ft_strclchr.o ft_atoi.o ft_strcat.o ft_strrchr.o ft_memcmp.o ft_memset.o ft_strcmp.o ft_srtrmstr.o ft_strchr.o ft_isit.o ft_putnbr.o ft_bzero.o ft_memchr.o ft_strdup.o ft_strinv.o ft_strclr.o ft_strjoin.o ft_strtdel.o ft_memdel.o ft_strnequ.o ft_strcpy.o ft_strequ.o ft_strsplit.o ft_getndigits.o get_next_line.o ft_tabmax.o ft_memccpy.o ft_lstmanage_funcs.o ft_memmove.o ft_strmap.o ft_itoa.o ft_mat.o ft_pmem.o ft_memcpy.o ft_strncpy.o ft_strstr.o ft_readfile.o \
	stack_indent.o
